...
def send_to_github(filename=""):
  if filename != "":
    return redirect("https://github.com/topological-modular-forms/mess-project-gerby/blob/master/%s" % filename)
  else:
    return redirect("https://github.com/topological-modular-forms/mess-project-gerby")
